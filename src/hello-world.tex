...
of the \mintinline{c}{stdio.h} \emph{header} in our source code.  We'll
...
In our case, we intend to return an \mintinline{c}{int} and denote no
parameters with \mintinline{c}{void}.  What's also important to note
here is that \mintinline{c}{main()} is a special function as it serves
...
For our call to \mintinline{c}{printf()}, we've provided the \emph{%
